...
plot arch using 1:2:($4/10) with image title '', \
 arch using 1:2:(sprintf('%.1f', ($4/10.0))) with labels font ',10' title ''
...
plot arch using 1:2:($6/$4) with image title '', \
 arch using 1:2:(sprintf('%.2f', $6/$4)) with labels font ',10' title '' 
