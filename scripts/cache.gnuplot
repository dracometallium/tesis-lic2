...
plot arch using 1:($3/escala) with linespoints lt 1 title '1 fragmento', \
 ...
 arch using 1:($7/escala) with linespoints lt 3 title '6 fragmentos', \
 arch using 1:($9/escala) with linespoints lt 4 title '12 fragmentos'
...
plot arch using 1:($2/escala) with linespoints lt 1 title '1 fragmento', \
 ...
 arch using 1:($6/escala) with linespoints lt 3 title '6 fragmentos', \
 arch using 1:($8/escala) with linespoints lt 4 title '12 fragmentos'
