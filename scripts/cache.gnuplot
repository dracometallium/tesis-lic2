...
set title ""
plot arch using 1:($2/escala) with linespoints lt 4 title '1 fragmento', \
 arch using 1:($3/escala) with linespoints lt 2 title '2 fragmentos', \
 arch using 1:($4/escala) with linespoints lt 3 title '6 fragmentos', \
 arch using 1:($5/escala) with linespoints lt 1 title '12 fragmentos'
