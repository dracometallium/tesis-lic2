...
$N$ componentes. Para las imágenes de escala de grises solo se utiliza un
componente, mientras que para las imágenes a color se utilizan 3 o 4,
dependiendo del espacio de colores. Los espacios de colores mas comunes son
...
\begin{description}
	...
	\item[Extracción de características:] Consiste en el reconocimiento de
		...
		regiones y masas\footnote{En la bibliografía en ingles se
...
\begin{figure}[!ht]
	...
	\caption{Etapas de procesamiento de un sistema de visión por computadora}
