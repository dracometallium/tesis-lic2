...
sistema para el vídeo de 800$\times$600 píxeles es de $3.92\times$, mientras que
para el vídeo 1280$\times$720 es de $5.42\times$. Las curvas de \emph{speedup}
...
\begin{figure}[h]
	...
	\caption{\emph{Speedup} para el vídeo de 800$\times$600 píxeles}
	\label{speedUp800}
