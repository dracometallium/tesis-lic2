...
Nota de OSO: Esto es como lo entendí? El experimento este no representa las
cuatro cámaras sino que es un intermedio

Como punto de partida de la presente tesis, nos formulamos la pregunta de si el
framework soportaría este nuevo caudal de información. Al probar el servidor de
vídeo, construido sobre el framework, con un vídeo con una resolución de
800$\times$600 píxeles, comprobamos que el número de cuadros por segundo
procesados cayó a 45 cuadros por segundo.
