...
\vspace{-2.5cm}
\mbox{\hspace{-1cm}\includegraphics[width=2.5cm,height=2.5cm]{logos/uncoma.pdf}\hspace{13cm} \includegraphics[width=2.5cm,height=2.5cm]{logos/fai.pdf}}
...
{\Large Director: Dr. Javier Balladini}\\
\ \\
{\Large Codirector: Esp. Eduardo Grosclaude}\\
