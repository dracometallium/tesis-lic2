...
Si se desea que un bloque sea ejecutado soló por un hilo se pueden utilizar las
...
ejecución, seguida de la directiva \emph{master} o \emph{single} para que soló
