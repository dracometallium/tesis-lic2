...
colocadas en una cola. Cuando un hilo termina de ejecutar una tarea, si hay
tareas esperando en la cola, toma una y la ejecuta. El modelo de \emph{fork and
...
asignada a uno de ellos, sino es colocada en una cola. Cuando un hilo termina de
ejecutar una tarea, toma otra de la cola de tareas o espera. Sólo se destruyen
los hilos al terminar la ejecución de todas las tareas y salir de la región de
trabajo compartido.
