...
Dado que en la \emph{SSL} el sistema de visión captura las imágenes desde puntos
fijos sobre la cancha y que los marcadores sobre los robots están especialmente
diseñados para ser identificados fácilmente, consideramos que el sistema de
visión global de la \emph{SSL} es suficientemente sencillo como para ser
utilizado con el fin de introducir a los alumnos a la visión por computadora.
