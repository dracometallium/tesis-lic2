...
\begin{description}
	...
	\item[Liga simulada]: Tanto los robots como el ambiente son simulados.
		...
		simulación tiene información precisa de la posición de todos
		los robots y la pelota en la cancha virtual, pero le entrega a
		los agentes de software información relativa a su posición y
		orientación, y con ruido.

	\item[Liga de tamaño pequeño]: También llamada \emph{SSL}, del ingles
		\emph{Small Size League}, es la liga más antigua de la
		\emph{RoboCup}.

	\item[Liga de tamaño mediano]:

	\item[Plataforma Standard]:
