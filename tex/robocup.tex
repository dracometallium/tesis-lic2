...
\begin{description}
	...
	\item[Liga de tamaño pequeño:] También llamada \emph{SSL}, del ingles
		...
		sistema centralizado. La visión es global y compartida por
		ambos equipos. Los robots se mueven sobre ruedas y tienen un
		``pie'' para patear la pelota.
...
En este trabajo nos enfocaremos en la \emph{SSL}.
