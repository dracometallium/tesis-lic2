...
se encuentren en los bordes inferior y derecho posiblemente serán más pequeños,
ya que las dimensiones del cuadro pueden no ser divisibles por el número de
...
\begin{description}
	...
	\item[FrameSlicer:] Subclase de \emph{ItemSlicer}. Cada cuadro es
		...
		sean más pequeños). Cada subcuadro incluye un área solapada con
