...
sistema, incluyendo inicialización del sistema de captura, creación de plugins
...
falsa (lineas 30 a 68).

En cada iteración se verifica si hay hilos de ejecución libres y hay cuadros en
la cola de cuadros. De ser este el caso, se toma un cuadro de la pila de cuadros
(lineas 32 a 38), se reduce la cantidad de hilos libres y se crea una tarea de
fragmentación de cuadro con una copia privada del puntero al cuadro (lineas 39 a
42). Para reducir el tiempo durante el cual los cuadros no se procesan aun
existiendo recursos libres, si no se cumplen las condiciones el bucle vuelve a
ejecutar la verificación, implementando una espera activa.
