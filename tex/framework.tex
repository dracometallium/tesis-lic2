...
ejecuta y crea las tareas principales del framework. La función principal
...
función comienza estableciendo la cantidad de hilos libres como la cantidad de
hilos de búsqueda (linea 28), luego se crean los hilos de búsqueda más uno para
la tarea de generación de tareas fragmentación de cuadros (linea 29). La tarea
de generación de tareas de fragmentación de cuadros consta de un bucle que
termina cuando la estructura de control \emph{continuar} es falsa (lineas 31 a
68).

En cada iteración se verifica si hay hilos libres y hay cuadros en la cola de
cuadros, se toma un cuadro de la pila de cuadros (lineas 32 a 38). En caso de
que se haya tomado un cuadro se reduce la cantidad de hilos libres y se crea una
tarea de fragmentación de cuadro con una copia privada del puntero al cuadro (lineas 39 a
42). La tarea de fragmentación de cuadro (lineas 43 a 66).
