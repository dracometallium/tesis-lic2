...
\begin{description}
	...
	\item[Generación de tareas dinámicas:] Esta tarea sera la encargada de
		tomar un cuadro de la cola de cuadros a procesar cuando la cantidad
		de tareas en ejecución sea menor que el máximo establecido, y
		crear una tarea de fractura para este. Esta es una tarea
		estática.
