...
\item[ItemSwitch:] Esta es la clase mas compleja del framework básico, ya que
	es la que crea las múltiples tareas. La primera tarea que crea es la
	encargada de consumir los ítems del buffer y crear las tareas de
	búsqueda. Cada tarea de búsqueda crea una nueva tarea por cada pila de
	plugins. Cada tarea de pila divide el ítem utilizando el
	\emph{ItemSlicer} y crea una nueva tarea por cada fragmento.
