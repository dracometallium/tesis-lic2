...
(\emph{main}, linea 1 a 23) se crean las tareas de generación de cuadros (lineas
6 a 9) y generación de tareas de fragmentación de cuadros (lineas 10 a 14). El
...
(linea 29). La tarea de generación de tareas de fragmentación de cuadros
implementa un espera ocupada sobre la cola de cuadros a procesar para reducir el
tiempo durante el cual los cuadros no se procesan aun existiendo recursos
libres. La tarea termina cuando la variable \emph{continuar} es falsa.

Cuando hay hilos de ejecución libres y cuadros en la cola de cuadros se toma un
cuadro de la pila de cuadros (lineas 32 a 38), se reduce la cantidad de hilos
libres y se crea una tarea de fragmentación de cuadro con una copia privada del
puntero al cuadro (lineas 39 a 42).
