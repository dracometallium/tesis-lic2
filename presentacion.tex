...
\frametitle{Maquinas de memoria compartida y distribuida}

\begin{figure}[h]

	\centering
	\includegraphics[height=0.33\textheight]{img/memCompartida.pdf}

	~

	\centering
	\includegraphics[height=0.33\textheight]{img/memDistribuida.pdf}
